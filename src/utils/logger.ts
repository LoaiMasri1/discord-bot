...
type LoggerType = "info" | "warn" | "error" | "cmd" | "event" | "success";

export class Logger {
  static log(content: string, type: LoggerType = "info") {
    ...
    switch (type) {
      ...
      case "cmd": {
        return console.log(
          `${chalk.hex("#1FAC64")(
            ` ❯ COMMANDS ${chalk.hex("#1FAC64")(`[${date}]`)} `
